...
using SportEventManager.Core.ProjectAggregate.Events;
using SportEventManager.Core.ProjectAggregate.Handlers;
using Moq;
using Xunit;

namespace SportEventManager.UnitTests.Core.Handlers;
