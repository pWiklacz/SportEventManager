using SportEventManager.Core.ContributorAggregate.Events;
using SportEventManager.SharedKernel.Interfaces;
using SportEventManager.Core.ProjectAggregate.Specifications;
using MediatR;

namespace SportEventManager.Core.ProjectAggregate.Handlers;
